const products = [
  ...
  // //forEach
  // let sum2 = 0;
  // const arr1 = numbers.forEach(function (number) {
  //   sum2 = sum2 + number;
  // });
  // // console.log(arr1);
  ...
  // const arr2 = numbers.map(function (number) {
  //   // console.log(number)
  //   return number + 100;
  // });
  ...
  //1. list the product price greater than 200$
    const expensiveProduct = products.filter(product => product.price > 200);
    expensiveProduct.forEach(product =>{
      console.log (`${product.id} - $${product.price}`);
    })


    // const highProduct = products.filter(pr)

  //2. Increase the price of all products by 10$
  // const updateProduct = products.map(function (number){
...
//   const product = products.find(prod => prod.title === "MBJ Women's Solid Short Sleeve Boat Neck V");
// console.log(product);

  
  //5. Find the product whose name has text Mens
  // const product = products.filter(prod => prod.title.includes("Mens"));
  // console.log(product);
  // fruits array
